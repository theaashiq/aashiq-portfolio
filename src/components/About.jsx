    ...
    <>
      <motion.div 
        ...
        <p className='about-details' style={{color: darkMode ? '#c8c9c9' : '#333'}}>
          ...
          I’m a Junior Web Developer with a solid understanding of React JS, Node.js, 
          Express, MongoDB, HTML and  CSS. I enjoy building clean and user-friendly websites, focusing on 
          writing good code. I’m always eager to learn new things and keep up with the latest trends
          in web development. I’m ready to bring my skills to team projects, helping to create smooth 
          and effective web experiences. With strong problem-solving skills, I am committed to finding 
          the best solutions for any challenges that come my way. My attention to detail ensures that 
          every project I work on is polished and professional.
        </p>
      </motion.div>
